...
export const COPILOT_ALTERNATIVE: Article = {
  ...
  dek: 'GitHub Copilot is a subscription. FreeAgentCoder is free, open source, and runs on API keys you already have — or can get for free in about a minute.',
  updated: '2026-09-16',
  blocks: [
    ...
    table(
      ...
      [
        ['Cost', '$10–39/month per seat', 'Free. MIT licensed.'],
...
export const ARTICLES = [COPILOT_ALTERNATIVE, GEMINI_API_VSCODE, BEST_FREE_AI_CODING];
